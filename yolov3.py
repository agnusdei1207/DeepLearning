...
Original file is located at
    https://colab.research.google.com/drive/1vK0qDKBfAvIrNgHauDURUjBSS3SOGBaT

Pedestrian Tracking with YOLOv3 and DeepSORT

This is a pedestrian tracking demo using the open source project ZQPei/deep_sort_pytorch which combines DeepSORT with YOLOv3.
